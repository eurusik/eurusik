...
const ThreadsIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 192 192" fill="currentColor" aria-label="Threads">
...
// Custom DOU icon
const DOUIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 121.517 43.438" fill="currentColor">
...
const Header = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/eurusik',
      icon: <Github size={20} />,
      color: 'hover:text-gray-900'
    },
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/eugene-rusakov-27606352/',
    ...
    {
      name: 'Threads',
      url: 'https://www.threads.net/@eurusik',
      icon: <ThreadsIcon size={20} />,
      color: 'hover:text-black'
    },
    {
      name: 'DOU',
      url: 'https://dou.ua/users/john-rusakov/',
      icon: <DOUIcon size={20} />,
